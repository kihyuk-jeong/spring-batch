...
import level.common.JobParametersDecide;
import level.common.LevelUpJobExecutionListener;
import level.common.SaveUserTasklet;
import level.common.domain.order.OrderStatistics;
import level.common.domain.user.User;
import level.common.domain.user.UserRepository;
...
public class UserConfiguration {
    ...
    /**
     * userLevelUpStep() 실행 이후, JobParametersDecide 에 의해 CONTINUE 가 반환되면 그 다음 Step 을 실행한다.
     */
    @Bean(JOB_NAME)
